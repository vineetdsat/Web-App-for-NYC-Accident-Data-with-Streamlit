...
st.markdown("This is a Application using a Streamlit Dash board used to Analyze Motor Vehiches Crashes in New York City")
...
hour = st.slider("Hour to lokk at", 0, 23)
